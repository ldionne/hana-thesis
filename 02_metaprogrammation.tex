...
une fonction \cc{f} qui ``prend'' un type \cc{T}, et qui ``renvoie'' le
type \cc{T*}. Attention, ici \cc{T} n'est pas le domaine de la fonction
\cc{f}. En fait, mathématiquement, on pourrait écrire
\begin{align*}
